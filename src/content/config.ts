...
const pain = defineCollection({
  schema: z.object({
    ...
    levain_mere_g: z.number().optional(),
    levain_mere_hydration: z.number().optional(),
    levain_rafraichi_eau_g: z.number().optional(),
    levain_rafraichi_farine_g: z.number().optional(),
